...
export function TransactionActions({
  ...
  if (myRole === 'buyer' && status === 'accepted') {
    actions.push(
      <Dialog key="fund" open={fundOpen} onOpenChange={setFundOpen}>
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Fund escrow &mdash; {amount}</DialogTitle>
            <DialogDescription>
              You&apos;ll be redirected to Paystack to complete payment
              securely. Funds are only released once you confirm delivery.
            </DialogDescription>
          </DialogHeader>
          <div className="flex flex-col gap-2">
            <Label htmlFor="fund-email">Email for receipt</Label>
            <Input
              id="fund-email"
              type="email"
              value={fundEmail}
